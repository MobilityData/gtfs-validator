...
class ValidateNoOverlappingStopTimeInTripBlockTest {
    ...
    @Test
    void overlappingTripsWithDifferentServiceIdShouldGenerateNoticeWhenOnlyCalendarAreProvided() {
        // trips.txt
        // | routeId | tripId | serviceId | blockId |
        // |---------|--------|-----------|---------|
        // | 0       | 2      | a         | 7       |
    ...
    @Test
    void overlappingTripsWithDifferentServiceIdShouldGenerateNoticeWhenOnlyCalendarDatesAreProvided() {
        // trips.txt
        // | routeId | tripId | serviceId | blockId |
        // |---------|--------|-----------|---------|
        // | 0       | 2      | a         | 7       |
    ...
    @Test
    void nonOverlappingTripsWithDifferentServiceIdShouldNotGenerateNoticeWhenOnlyCalendarAreProvided() {
        // trips.txt
        // | routeId | tripId | serviceId | blockId |
        // |---------|--------|-----------|---------|
        // | 0       | 2      | a         | 7       |
    ...
    @Test
    void nonOverlappingTripsWithDifferentServiceIdShouldNotGenerateNoticeWhenOnlyCalendarDatesAreProvided() {
        // trips.txt
        // | routeId | tripId | serviceId | blockId |
        // |---------|--------|-----------|---------|
        // | 0       | 2      | a         | 7       |
    ...
    @Test
    void nonOverlappingTripsWithDifferentServiceIdShouldNotGenerateNoticeWhenComparingTripsReferencingBothFiles() {
        // trips.txt
        // | routeId | tripId | serviceId  | blockId |
        // |---------|--------|----------- |---------|
        // | 0       | 2      | a          | 7       |
        ...
        // | 9      | 07:00       | 07:40         | 105    | 14            |
        // | 9      | 07:40       | 07:59         | 106    | 15            |
        ...
        // | serviceId | monday | tuesday | wednesday | thursday | friday | saturday | sunday | start_date | end_date |
        // |-----------|--------|---------|-----------|----------|--------|----------|--------|------------|----------|
        // | d         | 0      | 0       | 0         | 1        | 1      | 1        | 0      | 20200815   | 20200831 |
        ...
        // - service b is active only on 2020-09-04
        // - service c is active only on 2020-01-08
        // - service d is active from 2020-08-15 to 2020-08-31 on thursdays
        // all services are active on different days, hence no overlap.
        ...
        when(thirdMockTrip.getTripId()).thenReturn("9");
        when(thirdMockTrip.getServiceId()).thenReturn("d");
        when(thirdMockTrip.getBlockId()).thenReturn("7");
        when(thirdMockTrip.hasSameServiceId(any())).thenReturn(false);
        ...
        when(fourthTripFirstStopTime.getArrivalTime()).thenReturn(SEVEN_AM_AS_SECS_BEFORE_NOON);
        when(fourthTripFirstStopTime.getDepartureTime()).thenReturn(SEVEN_AM_40_MIN_AS_SECS_BEFORE_NOON);

        final StopTime fourthTripLastStopTime = mock(StopTime.class);
        when(fourthTripLastStopTime.getArrivalTime()).thenReturn(SEVEN_AM_40_MIN_AS_SECS_BEFORE_NOON);
        when(fourthTripLastStopTime.getDepartureTime()).thenReturn(SEVEN_AM_40_MIN_AS_SECS_BEFORE_NOON);
        ...
        underTest.execute(); // will produce NPE here because solution as not been implemented yet
        verifyNoInteractions(mockResultRepo);
    }

    @Test
    void overlappingTripsWithDifferentServiceIdShouldGenerateNoticeWhenComparingTripsReferencingBothFiles() {
        // trips.txt
        // | routeId | tripId | serviceId  | blockId |
        // |---------|--------|----------- |---------|
        // | 0       | 2      | a          | 7       |
        ...
        // Here services c and d overlap
        // - service c is active only on 2020-01-08
        // - service d is active from 2020-08-01 to 2020-08-31 on thursdays, which includes the only day service c is
        // active

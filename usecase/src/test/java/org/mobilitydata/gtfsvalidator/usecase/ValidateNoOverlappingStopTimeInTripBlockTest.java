...
class ValidateNoOverlappingStopTimeInTripBlockTest {
    ...
    @Test
    void infoNoticeShouldBeGeneratedAndAddedToResultRepoWhenFirstTripRefersToCalendarAndSecondRefersToCalendarDate() {
        // trips.txt
        // | routeId | tripId | serviceId  | blockId |
        // |---------|--------|----------- |---------|
        // | 0       | 2      | a          | 7       |
        ...
        // | 0       | 2      | a         | 7       | 05:00           | 06:30          |
        // | 0       | 5      | b         | 7       | 07:00           | 10:00          |
        // | 0       | 8      | d         | 7       | 11:03           | 11:20          | <- refers to calendar.txt
        // | 1       | 9      | c         | 7       | 11:10           | 12:45          | <- refers to calendar_dates.txt
    ...
    void infoNoticeShouldBeGeneratedAndAddedToResultRepoWhenFirstTripRefersToCalendarDateAndSecondRefersToCalendar() {
        ...
        // - service c is active only on 2020-08-20

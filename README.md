...
1. Download the [v3.0.0-beta release jar](https://github.com/MobilityData/gtfs-validator/releases/download/v3.0.0-beta/gtfs-validator-v3.0.0-beta_cli.jar) of the validator.

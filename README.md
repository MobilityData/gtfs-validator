...
Note: 
 - **export validation report as `.json` file**: After validating [MBTA's GTFS archive](https://cdn.mbta.com/MBTA_GTFS.zip) on 2020-10-20 at 09:07:48 (America/Montreal timezone), the validation report will be named as follows `MBTA_2020-10-20 09/07/48.442365.json`
 - **export validation report as `.pb` file**: after validating [MBTA's GTFS archive](https://cdn.mbta.com/MBTA_GTFS.zip) on 2020-10-20 at 09:07:48 (America/Montreal timezone), the validation reports will be named as follows 
   - `MBTA_2020-10-20 09/07/48.442365-1.pb` 
   - `MBTA_2020-10-20 09/07/48.442365-2.pb` 
   - ...
   - `MBTA_2020-10-20 09/07/48.442365-n.pb` 
   
In the case where GTFS file`feed_info.txt`  is not provided, the validation report name would be limited to: `_2020-10-20 09/07/48.442365.json` or `_2020-10-20 09/07/48.442365-1.pb`    

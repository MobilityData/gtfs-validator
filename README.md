...
- To validate a GTFS dataset on your computer, run the following command in the terminal, replacing the text in brackets:
  - `java -jar [name of the jar file] -i [path to the GTFS file] -o [name of the output directory]`
...
- To validate a GTFS dataset from a URL, run the following command in the terminal:
  - `java -jar [name of the jar file] -u [URL to the GTFS file] -o [name of the output directory] -c ca`

...
public class RunValidatorEndpointTest {
  ...
  //
  //    // verify that the validationHandler is called with the downloaded feed file, output path,
  // and
  //    // country code
  ...
  //    verify(validationHandler, times(0)).validateFeed(any(File.class), any(Path.class),
  // anyString());
  //

...
public class GtfsValidatorControllerTest {
  ...
  public void malformedUrl_badRequest() throws Exception {
    mockMvc.perform(MockMvcRequestBuilders.get("/?url=malformed url&country_code=us"))
        .andExpect(MockMvcResultMatchers.status().isBadRequest()).andReturn();
  }

  @Test
  public void noGtfsInput_badRequest() throws Exception {
    mockMvc.perform(MockMvcRequestBuilders.get("/?url=http://webapps.thebus.org/transitdata/Production/google_transit&country_code=us"))
        .andExpect(MockMvcResultMatchers.status().isBadRequest()).andReturn();
  }
  ...
  public void noValidationReportBucketNotSet_preconditionFailed() throws Exception {
    ...
    mockMvc.perform(MockMvcRequestBuilders.get("/?url=http://webapps.thebus.org/transitdata/Production/google_transit.zip&country_code=us"))

 ...
 * There are two common cases that trigger this error:
 *   1) The root folder (e.g., a folder called "GTFS 2020") was zipped instead of the individual
 *      files within the folder (e.g., `calendar.txt`, `agency.txt`, etc.). This can be fixed
 *      by zipping the files directly instead.

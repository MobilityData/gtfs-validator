...
public class NoticeViewTest {
  ...
  private static final Notice notice = new MissingRequiredFieldNotice(FILENAME_VALUE, CSV_ROW_NUMBER_VALUE, FIELD_NAME_VALUE);
  ...
  private static final List<String> MISSING_REQUIRED_FIELD_NOTICE_FIELDS = new ArrayList<>(List.of(FILENAME, CSV_ROW_NUMBER, FIELD_NAME));
  ...
  public void getValueForFieldTest() {
    ...
    assertEquals(noticeView.getValueForField(CSV_ROW_NUMBER), new JsonPrimitive(CSV_ROW_NUMBER_VALUE));

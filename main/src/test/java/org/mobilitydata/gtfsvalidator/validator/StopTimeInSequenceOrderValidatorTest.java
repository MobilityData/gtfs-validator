...
public final class StopTimeInSequenceOrderValidatorTest {
  ...
  public void outOfOrder_yieldsNotice() {
    ...
    assertThat(generateNotices(stopTimes))
        .containsExactly(new TripWithOutOfOrderArrivalTimeNotice(stopTimes.get(1)),
  ...
  public void skippedValues_yieldsNoNotice() {
    ImmutableList<GtfsStopTime> stopTimes = ImmutableList.of(
        new GtfsStopTime.Builder()
            .setCsvRowNumber(2)
            .setTripId("trip1")
            .setStopSequence(1)
            ...
            .setShapeDistTraveled(10.0)
            .build(),
        new GtfsStopTime.Builder().setCsvRowNumber(3).setTripId("trip1").setStopSequence(2).build(),
        new GtfsStopTime.Builder()
            .setCsvRowNumber(4)
            .setTripId("trip1")
            .setStopSequence(3)

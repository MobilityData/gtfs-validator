...
public class StopTimeStopLocationTypeValidatorTest {
  ...
  public void stopTimesRefersNonStopsLocationType_generatesNotices() {
    WrongStopTimeStopLocationTypeNotice[] validationNotices = {
        new WrongStopTimeStopLocationTypeNotice(15, "trip id value", 8, "station id value",
            GtfsLocationType.STATION.name()),
        new WrongStopTimeStopLocationTypeNotice(10, "other trip id value", 55, "entrance id value",
            GtfsLocationType.ENTRANCE.name()),
        new WrongStopTimeStopLocationTypeNotice(12, "some trip id value", 35,
            "generic node id value", GtfsLocationType.GENERIC_NODE.name()),
        new WrongStopTimeStopLocationTypeNotice(55, "another trip id value", 18,
            "boarding area id value", GtfsLocationType.BOARDING_AREA.name()),
    };
    assertThat(generateNotices(
        ImmutableList.of(
            createStopTime(1, "trip id value", "stop id value", 5),

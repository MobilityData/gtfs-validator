...
public class StopTimesTripBlockOrderValidatorTest {
  ...
  public void UnsortedStopTimesNotice_generateNotice_nonContiguousTripBlock() {
    ...
    assertTrue(generateNotices(stopTimes).contains(new StopTimesTripBlockOrderValidator.UnsortedStopTimesNotice("0914", 1, 4)));
  }
  ...
  public void UnsortedStopTimesNotice_generateNotice_nonIncreasingStopSequence() {
    ...
    assertTrue(generateNotices(stopTimes).contains(new StopTimesTripBlockOrderValidator.UnsortedStopTimesNotice("0916", 1, 3)));
  }
}

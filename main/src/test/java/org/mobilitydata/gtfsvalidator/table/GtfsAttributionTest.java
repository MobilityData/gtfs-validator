...
public class GtfsAttributionTest {
  ...
  public void shouldReturnDefaultValuesForMissingValues() {
    ...
    assertThat(underTest.isAuthority())
        .isEqualTo(GtfsAttributionRole.forNumber(DEFAULT_IS_AUTHORITY));
    assertThat(underTest.isOperator())
        .isEqualTo(GtfsAttributionRole.forNumber(DEFAULT_IS_OPERATOR));
    assertThat(underTest.isProducer())
        .isEqualTo(GtfsAttributionRole.forNumber(DEFAULT_IS_PRODUCER));

...
public class GtfsFareAttributeTableLoaderTest {
    ...
    public void validFileShouldNotGenerateNotice() throws IOException {
        ...
        GtfsFareAttributeTableContainer tableContainer =
                (GtfsFareAttributeTableContainer) loader.load(reader, FEED_NAME, validatorLoader, noticeContainer);
    ...
    public void missingRequiredFieldShouldGenerateNotice() throws IOException {
        ...
        assertThat(noticeContainer.getNotices().get(0).getContext()).containsEntry("filename", "fare_attributes.txt");
        assertThat(noticeContainer.getNotices().get(0).getContext()).containsEntry("csvRowNumber", 2L);
        assertThat(noticeContainer.getNotices().get(0).getContext()).containsEntry("fieldName", "currency_type");

...
public class GtfsStopTimeTest {
  ...
  public void shouldReturnDefaultValuesForMissingValues() {
    ...
    assertThat(underTest.dropOffType())
        .isEqualTo(GtfsPickupDropOff.forNumber(DEFAULT_DROP_OFF_TYPE));
    ...
    assertThat(underTest.timepoint())
        .isEqualTo(GtfsStopTimesTimepoint.forNumber(DEFAULT_TIMEPOINT));

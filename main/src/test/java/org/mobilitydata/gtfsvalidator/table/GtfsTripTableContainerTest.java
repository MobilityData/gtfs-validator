...
public class GtfsTripTableContainerTest {
  @Test
  public void forEmptyFile() {
    GtfsTripTableContainer tableContainer = GtfsTripTableContainer.forEmptyFile();
    assertThat(tableContainer.getEntities()).isEmpty();
    assertThat(tableContainer.gtfsFilename()).matches("trips.txt");
  ...
  public void forMissingFile() {
    GtfsTripTableContainer tableContainer = GtfsTripTableContainer.forMissingFile();
    assertThat(tableContainer.getEntities()).isEmpty();
    assertThat(tableContainer.gtfsFilename()).matches("trips.txt");
  ...
  public void forInvalidHeaders() {
    GtfsTripTableContainer tableContainer = GtfsTripTableContainer.forInvalidHeaders();
    assertThat(tableContainer.getEntities()).isEmpty();
    assertThat(tableContainer.gtfsFilename()).matches("trips.txt");
    assertThat(tableContainer.isEmptyFile()).isFalse();
  ...
  public void forEntities() {
    ...
    GtfsTrip trip = new GtfsTrip.Builder().build();
    tripCollection.add(trip);
    GtfsTripTableContainer tableContainer =
        GtfsTripTableContainer.forEntities(tripCollection, noticeContainer);

...
import static org.mobilitydata.gtfsvalidator.table.GtfsLevel.DEFAULT_LEVEL_ID;
import static org.mobilitydata.gtfsvalidator.table.GtfsLevel.DEFAULT_LEVEL_INDEX;
import static org.mobilitydata.gtfsvalidator.table.GtfsLevel.DEFAULT_LEVEL_NAME;
...
public class GtfsLevelTest {
  ...
  public void shouldReturnFieldValues() {
    ...
    GtfsLevel underTest =
        builder.setLevelId("level id").setLevelIndex(2d).setLevelName("level name").build();
  ...
  public void shouldReturnDefaultValuesForMissingValues() {
    GtfsLevel.Builder builder = new GtfsLevel.Builder();
    GtfsLevel underTest = builder.setLevelId(null).setLevelIndex(null).setLevelName(null).build();
  ...
  public void shouldResetFieldToDefaultValues() {
    GtfsLevel.Builder builder = new GtfsLevel.Builder();
    builder.setLevelId("level id").setLevelIndex(2d).setLevelName("level name");
    builder.clear();

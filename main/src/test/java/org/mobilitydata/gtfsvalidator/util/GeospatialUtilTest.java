...
public class GeospatialUtilTest {
  ...
  public void stopWithinTripShapeBufferShouldNotGenerateNotice() {
    ...
    GtfsTrip trip = createTrip(4, "r1", "service1", "t1", "shape1");
    ...
    List<StopTooFarFromTripShapeNotice> underTest =
        GeospatialUtil.checkStopsWithinTripShape(
            trip.tripId(), stopTimes, trip.shapeId(), shapePoints, stopTable, new HashSet<>());
  ...
  public void twoTripsWithSameShapeStopOutsideBufferShouldGenerateOneNotice() {
    NoticeContainer noticeContainer = new NoticeContainer();
    GtfsTrip firstTrip = createTrip(4, "r1", "service1", "t1", "shape1");
    GtfsTrip secondTrip = createTrip(9, "r1", "service1", "t2", "shape1");
    ...
    List<StopTooFarFromTripShapeNotice> underTest =
        GeospatialUtil.checkStopsWithinTripShape(
            firstTrip.tripId(), stopTimes, firstTrip.shapeId(), shapePoints, stopTable, testedCache);
    ...
    underTest.addAll(
        GeospatialUtil.checkStopsWithinTripShape(
            secondTrip.tripId(), stopTimes, secondTrip.shapeId(), shapePoints, stopTable, testedCache));
    assertThat(underTest)
        .containsExactly(new StopTooFarFromTripShapeNotice("1003", 3, "t1", "shape1", 100));
  }
  ...
  public void tripWithoutShapeShouldNotGenerateNotice() {
    NoticeContainer noticeContainer = new NoticeContainer();
    GtfsTrip trip = createTrip(4, "r1", "service1", "t1", null);
    List<GtfsStopTime> stopTimes =
        ImmutableList.of(createStopTime(5, "t1", "1001", 1), createStopTime(8, "t1", "1002", 2));

...
/**
 * Validates that no pathway links to a stop with stop_access == 1, which should be accessible outside of the station’s pathways.
 *
 * <p>Stops with stop_access=1 should not have pathways that link to them since they can be accessed from the street and are independent of the pathways inside the station.
 *
...
public class PathwayStopAccessValidator extends FileValidator{
  ...
  /**
   * A pathway has an endpoint that is a stop with stop_access=1, which should be accessible outside of the station’s pathways.
   * <p>Stops with stop_access=1 should not have pathways that link to them since they can be accessed from the street and are independent of the pathways inside the station.
   */

...
class EntranceTest {
    ...
    private static final Entrance.EntranceBuilder underTest = new Entrance.EntranceBuilder();
    ...
    @Test
    public void createEntranceWithMinimizedValidDataShouldNotGenerateNotice() {
        ...
        assertTrue(buildResult.getData() instanceof Entrance);

        final Entrance toCheck = (Entrance) buildResult.getData();
    ...
    @Test
    public void createEntranceWithMaximizedValidDataShouldNotGenerateNotice() {
        underTest.parentStation(PARENT_STATION)
    ...
    @Test
    public void createEntranceWithNullParentStationShouldGenerateMissingRequiredValueNotice() {
    ...
    @Test
    public void createEntranceWithNullStopNameShouldGenerateMissingRequiredValueNotice() {
        underTest.parentStation(PARENT_STATION)
                .wheelchairBoarding(2)
                .stopId(STOP_ID)
                .stopName(null)

...
public class GtfsDatasetTooBigNotice extends ErrorNotice {
    public GtfsDatasetTooBigNotice(final float datasetSizeMegaBytes, final float maxDatasetSizeMegaBytes) {
        super(null,
                E_059,
                "GTFS dataset too big",

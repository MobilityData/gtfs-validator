...
| Base add-ons            | Cars Allowed              | One **cars_allowed** value in [trips.txt](https://gtfs.org/schedule/reference/#tripstxt)  |  https://gtfs.org/getting-started/features/base-add-ons/#cars-allowed|
...
| Base add-ons             | Stop Access               | One **stop_access** value in [stops.txt](https://gtfs.org/documentation/schedule/reference/#stopstxt) | https://gtfs.org/getting-started/features/base-add-ons/#stop-access |
...
| Fares                    | Fare Media                | One line of data in [fare_media.txt](https://gtfs.org/schedule/reference/#fare_mediatxt) AND One line of data in [fare_products.txt](https://gtfs.org/schedule/reference/#fare_productstxt) AND One **fare_media_id** value in [fare_products.txt](https://gtfs.org/schedule/reference/#fare_productstxt) |  https://gtfs.org/getting_started/features/fares/#fare-media |
| Fares                    | Rider Categories                | One line of data in [rider_categories.txt](https://gtfs.org/schedule/reference/#ridercategoriestxt) AND One line of data in [fare_products.txt](https://gtfs.org/schedule/reference/#fare_productstxt) AND One **rider_category_id** value in [fare_products.txt](https://gtfs.org/schedule/reference/#fare_productstxt) |  https://gtfs.org/getting_started/features/fares/#rider-categories |
| Fares                    | Route-Based Fares         | (One **network_id** value in [routes.txt](https://gtfs.org/schedule/reference/#routestxt)<br/>OR<br/>one line of data in [networks.txt](https://gtfs.org/schedule/reference/#networkstxt)) AND One line of data in [fare_products.txt](https://gtfs.org/schedule/reference/#fare_productstxt) AND One line of data in [fare_leg_rules.txt](https://gtfs.org/schedule/reference/#fare_leg_rulestxt) AND One **network_id** value in [fare_leg_rules.txt](https://gtfs.org/schedule/reference/#fare_leg_rulestxt)   |    https://gtfs.org/getting_started/features/fares/#route-based-fares   |
...
| Flexible Services        | Fixed-Stops Demand Responsive Services         | One record in [location_groups.txt](https://gtfs.org/documentation/schedule/reference/#location_groupstxt) AND at least one trip in [stop_times.txt](https://gtfs.org/documentation/schedule/reference/#stop_timestxt) references only **location_group_id** |https://gtfs.org/getting_started/features/flexible_services/#fixed-stops-demand-responsive-services|

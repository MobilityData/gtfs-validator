...
**Within the scope of the new validator**, create a new `static` class and make it extend [`ValidationNotice`](../core/src/main/java/org/mobilitydata/gtfsvalidator/notice/ValidationNotice.java) as follows: 
```java
  /**
...
[`See sample example`](../main/src/test/java/org/mobilitydata/gtfsvalidator/validator/FeedExpirationDateValidatorTest.java).
...
[`See sample example`](../main/src/test/java/org/mobilitydata/gtfsvalidator/validator/TripUsabilityValidatorTest.java).

...
|[`AgencyIdMissingOrBlankNotice`](#AgencyIdMissingOrBlankNotice)| [E031](https://github.com/MobilityData/gtfs-validator/blob/v1.4.0/RULES.md#E031)| Blank or missing `agency.agency_id`. |
...
<a name="AgencyIdMissingOrBlankNotice"/>

### AgencyIdMissingOrBlankNotice

When provided `agency.agency_id` should not be blank. `agency.agency_id` should be provided even if `agency.txt` contains an unique row.

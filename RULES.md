...
| [E034](#E034) | `shape_id` must be provided and exist in GTFS data when stop_times.shape_dist_travelled is provided |
...
### E034 - `shape_id` must be provided and exist in GTFS data when stop_times.shape_dist_travelled is provided

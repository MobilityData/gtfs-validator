...
| [`missing_stop_name`](#missing_stop_name)                                                                                         | Missing required `stop_name` for stop with location type of `0`, `1`, or `2`.                                                                                                  |
...
Missing required `stop_name` for stop with location type of `0`, `1`, or `2`.

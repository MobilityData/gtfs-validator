...
class ProtobufNoticeExporterTest {
    ...
    @Test
    void exportIncoherentValuesForFieldsShouldMapToCsvProblemAndWriteToStream() throws IOException {
        ...
        ProtobufNoticeExporter underTest = new ProtobufNoticeExporter(mockBuilder, mockStreamGenerator);
        underTest.export(new IncoherentValuesForFields(FILENAME, "field_name",
